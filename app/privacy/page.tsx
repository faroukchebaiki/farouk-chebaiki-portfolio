      ...
      <section className="container mx-auto max-w-3xl px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="rounded-2xl border border-border bg-card p-5 sm:p-6">
          <p className="text-sm text-muted-foreground">
            This page explains what data this site collects, why, and how you can exercise
            your privacy rights (GDPR/EEA, UK, and US CCPA/CPRA).
          </p>
          <nav className="mt-4 grid gap-2 text-sm">
            ...
            <a className="hover:underline underline-offset-4" href="#collection">
              What data I collect
            </a>
            ...
            <a className="hover:underline underline-offset-4" href="#legal-bases">
              Legal bases (GDPR)
            </a>
            <a className="hover:underline underline-offset-4" href="#rights-gdpr">
              Your rights — GDPR/EEA & UK
            </a>
            <a className="hover:underline underline-offset-4" href="#rights-ccpa">
        ...
        <Section id="who" title="Who I am">
          <p>
            ...
            <strong>Farouk Mohamed Chebaiki</strong>, a freelance Full-Stack Developer.
            The purpose of this site is to showcase my work and make it easy to get in
        ...
        <Section id="scope" title="Scope of this policy">
          <p>
            This policy applies to <strong>farouk.uk</strong> and its sub-pages. It covers
            analytics captured by this site and any information you choose to send me by
        ...
        <Section id="collection" title="What data I collect">
          ...
          <p className="mt-2 text-muted-foreground">
            I do <strong>not</strong> run user accounts, contact forms, comments, or
            trackers that fingerprint you. I do <strong>not</strong> use advertising
            cookies.
          </p>
          ...
          <p className="mt-2 text-muted-foreground">
            ...
            services listed below (page views, device type, referrers, etc.). These are
            aggregated and not used to identify you.
          </p>
        </Section>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                ...
                fingerprinting (e.g., page views, referrers, device types). This helps me
                understand site usage and performance without tracking individual users.
              </p>
              <p className="mt-2">
                Privacy policy:{" "}
                <a
            ...
            <div>
              ...
              <p className="mt-2 text-muted-foreground">
                Vercel Analytics provides aggregated traffic and performance insights. It
                does not create user profiles. I use it to ensure pages are fast and
        ...
        <Section id="email" title="Email and contact form">
          <p>
            If you email me or use the contact form on this site, I will see your name,
            email address, and the contents of your message. I use this only to respond to
            your inquiry.
          </p>
          <ul className="mt-3 list-disc pl-5 space-y-2 text-muted-foreground">
            <li>
              <strong>What’s collected:</strong> name, email, message, and optional
              subject.
            </li>
            <li>
              <strong>How it’s processed:</strong> the form submits to my server which
              forwards your message to my inbox using an email service (Resend). I do not
              persist your message in a site database.
            </li>
            <li>
              <strong>Anti‑spam:</strong> I use a hidden honeypot field and may add
              additional protections (e.g., rate limiting or CAPTCHA) to prevent abuse.
            </li>
            <li>
              <strong>Third parties:</strong> email delivery is handled by Resend. See
              Resend’s policy for details on processing and retention.
            </li>
            <li>
              <strong>Retention:</strong> messages remain in my email inbox as needed to
              manage the conversation or comply with legal obligations. You can request
        ...
        <Section id="legal-bases" title="Legal bases (GDPR)">
          <ul className="list-disc pl-5 space-y-2 text-muted-foreground">
            ...
            <li>
              <strong>Legal obligation</strong> — if I need to retain communications to
        ...
        <Section id="rights-ccpa" title="Your rights — US (CCPA/CPRA)">
          ...
          <p className="mt-3 text-muted-foreground">
            This site does not sell or share your personal information as defined by the
            CCPA/CPRA. To submit a request, contact{" "}
            <a className="underline underline-offset-4" href="mailto:me@farouk.uk">
              me@farouk.uk
            </a>
            .
        ...
        <Section id="retention" title="Data retention">
          <p className="text-muted-foreground">
            ...
            settings and is aggregated (non-identifying). Emails you send me may be kept
            as long as needed to handle your inquiry, resolve issues, or comply with legal
            requirements. You can ask me to delete your messages at any time.
          </p>
        </Section>
        ...
        <Section id="transfers" title="International transfers">
          <p className="text-muted-foreground">
            My site is deployed on global infrastructure (Vercel/Cloudflare). Data may be
            processed in data centers outside your country. Where applicable, I rely on
            the providers’ transfer safeguards and standard contractual clauses.
          </p>
        </Section>
        ...
        <Section id="security" title="Data security">
          <p className="text-muted-foreground">
            ...
            within my control. No method of transmission or storage is 100% secure, but I
            aim to use reputable providers and minimize the data I handle.
          </p>
        </Section>
        ...
        <Section id="children" title="Children’s privacy">
          <p className="text-muted-foreground">
            This site is not intended for children under 13 (or the applicable minimum age
            in your jurisdiction). I do not knowingly collect personal information from
            children.
          </p>
        </Section>
        ...
        <Section id="changes" title="Changes to this policy">
          <p className="text-muted-foreground">
            I may update this policy to reflect changes in technology, regulations, or my
            practices. Updates will be posted on this page with a revised date.
          </p>
        </Section>
